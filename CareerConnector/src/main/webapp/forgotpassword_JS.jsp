...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import = "org.mis.ConnectionProvider" %>
       <%UserBean userBean=(UserBean)session.getAttribute("Profile"); %>
<!doctype html>
<html>
<head>
<meta charset='utf-8'>
...
<link href='' rel='stylesheet'> <script type='text/javascript' src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
...
.form-control:focus {
	...
	border-color: #76b7e9;
	outline: 0;
	box-shadow: 0 0 0 0px rgb(36 106 175)
}
</style>
</head>
<body id="top">
    ...
    <section class="section-hero overlay inner-page bg-image"
            style="background-image: url('images/hero_1_2.jpg'); opacity: 0.7; padding : 28px;" id="home-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="custom-breadcrumbs">
                            ...
                            <a href="index_JS.jsp"><b style="color:white;">Log In</b></a> <span class="mx-2 slash">/</span>
...
<body oncontextmenu='return false' class='snippet-body'>
	<div class="container padding-bottom-3x mb-2 mt-5">
		<div class="row justify-content-center">
			<div style="padding-top: 10px;" class="col-lg-5 col-md-10">
        	...
        	<%}%>
				<form class="card mt-4" action="forgotPasswordAction_JS.jsp" method="POST">
					<div class="card-body">
						<div class="form-group">
							<label class="text-black" class="form-label" for="form3Example4cd">Registered email address</label>
							<input
								class="form-control" type="text" name="smail" id="email-for-pass" placeholder="Email address" required="">
						</div>

                 <div class="form-outline flex-fill mb-0">
                   <label class="text-black" class="form-label" for="form3Example4cd">Choose your security question</label>
                 </div>
                 <div>
                  <select name="SecurityQuestion" class="form-control" class="backup" style = "width : 402px; height : 35px;">
                     ...
                     <option value="">What is your favourite food?</option>
                        ...
                        <div class="form-outline flex-fill mb-0">
                          <label class="text-black" for="form3Example4cd" style = "margin-top : 21px;">Answer</label>
                          <input class="form-control" type="text" id="form3Example4cd" name="uanswer" placeholder = "Write your Security Answer" class="form-control" required>
                           ...
                           <div class="form-outline flex-fill mb-0">
                          <label class="text-black" for="form3Example4cd" style = "margin-top : 21px;">New Password</label>
                          <input class="form-control" type="password" id="form3Example4cd" name="jnpass" inputmode="numeric" minlength="6" maxlength="10" size="10" pattern="[A-Za-z0-9@#$%]{6,10}" title="Password must contains atleast one special character, one numeric value and one capital letter consisting of 6-10 digits" placeholder="Enter new password" class="form-control" required>
                           </div>

						   <div style="margin-top: 20px;">
                        <button href = "newpassword_JS.jsp" class="btn btn-primary btn:hover" type="submit" style="background-color: rgb(36 106 175); height: 38px;">Submit</button>
						<!-- &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                        <button href = "login_JS.jsp" class="btn btn-primary btn:hover" type="button" style="background-color: rgb(36 106 175); height: 38px;">Log In</button> -->
					</div>
					</div>
				</form>
			</div>

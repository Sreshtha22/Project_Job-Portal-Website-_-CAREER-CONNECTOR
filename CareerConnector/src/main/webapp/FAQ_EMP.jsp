          ...
          <div class="row">
              <div class="col-md-7">
                  ...
                  <div class="custom-breadcrumbs">
                      ...
                      <span class="text-white"><strong>FAQs</strong></span>
                  </div>
              </div>
          </div>
      </div>
  ...
  <section class="site-section" id="accordion">
      <div class="container">
        <div class="row accordion justify-content-center block__76208">
         <div style ="margin-right: 400px;" class="col-lg-15 ml-auto">
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="true" aria-controls="collapseFive">How do I create an account on Career Connector?<span class="icon"></span></a>
              </h3>
              <div id="collapseFive" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>To create an account, click on the "Sign Up" or "Register" button on the homepage, and follow the registration process.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false" aria-controls="collapseSix">How can I upload my resume to my profile?<span class="icon"></span></a>
              </h3>
              <div id="collapseSix" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>After logging in, navigate to your profile and find the option to upload or update your resume.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            ...
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseSeven" role="button" aria-expanded="false" aria-controls="collapseSeven"> How do I search for job listings?  <span class="icon"></span></a>
              </h3>
              <div id="collapseSeven" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Use the search bar on the homepage to enter keywords, location, and other filters to find relevant job listings.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            ...
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false" aria-controls="collapseEight">Can I set up job alerts for specific criteria?<span class="icon"></span></a>
              </h3>
              <div id="collapseEight" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Yes, you can set up job alerts in your profile to receive notifications when new jobs matching your criteria are posted.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseNine" role="button" aria-expanded="false" aria-controls="collapseNine">How can I apply for a job on Career Connector?<span class="icon"></span></a>
              </h3>
              <div id="collapseNine" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Click on the job listing you are interested in, and follow the application instructions provided by the employer.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseTen" role="button" aria-expanded="false" aria-controls="collapseTen">What should I include in my profile to make it stand out to employers?<span class="icon"></span></a>
              </h3>
              <div id="collapseTen" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Add a professional summary, relevant skills, work experience, and education to your profile.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseEleven" role="button" aria-expanded="false" aria-controls="collapseEleven"> How can I contact employers or respond to messages from them?<span class="icon"></span></a>
              </h3>
              <div id="collapseEleven" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Check your inbox for messages from employers and use the messaging feature to communicate with them.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseTwelve" role="button" aria-expanded="false" aria-controls="collapseTwelve">How do I post a job listing on Career Connector?<span class="icon"></span></a>
              </h3>
              <div id="collapseTwelve" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Log in to your employer account, and select the option to "Post a Job." Follow the prompts to provide details about the job.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseThirteen" role="button" aria-expanded="false" aria-controls="collapseThirteen">Can I browse resumes of job seekers on Career Connector?<span class="icon"></span></a>
              </h3>
              <div id="collapseThirteen" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Yes, you can search for job seekers and review their profiles and resumes to find suitable candidates.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseFourteen" role="button" aria-expanded="false" aria-controls="collapseFourteen">How do I manage job applications received through Career Connector?<span class="icon"></span></a>
              </h3>
              <div id="collapseFourteen" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>All job applications are stored in your employer dashboard for easy access and review.</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseFifteen" role="button" aria-expanded="false" aria-controls="collapseFifteen">Are there options for promoting job listings to reach a larger audience?<span class="icon"></span></a>
              </h3>
              <div id="collapseFifteen" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="body-text">
                  <p>Yes, you can explore premium job posting options to increase</p>
                </div>
              </div>
            </div> <!-- .accordion-item -->
          </div>

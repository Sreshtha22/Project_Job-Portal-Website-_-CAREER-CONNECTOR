...
<html lang="en">
  <head>
    <title>&mdash;Login As Job_Seeker</title>
    <meta charset="utf-8">
    ...
    <section class="site-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <h2 class="mb-4">Log In as Job Seeker</h2>
        	...
        	<%}%>
            <form action="LOGIN_JS" method = "post" class="p-4 border rounded">
              ...
              <div class="row form-group">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style = "margin-top : -1%;" width="20" height="60" fill="currentColor" class="ionicon" viewBox="0 0 512 512">
                  ...
                  <input type="email" id="fname" name = "smail" class="form-control" placeholder="Email address" required>
                </div>
              </div>
              ...
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="password" id="fname" name = "spass" class="form-control" placeholder="Password" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <h5 class="text-center text-black mt-3 mb-1"><a href='forgotpassword_JS.jsp'

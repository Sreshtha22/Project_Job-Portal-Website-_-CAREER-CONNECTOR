    ...
    <!-- HOME -->
     <div class="jobs">
        ...
        <section class="site-section">
                                ...
                                String title=null;
                                   ...
                                   try { 
                                    ...
                                    while(rs.next()) { 
                                        ...
                                        out.println("</strong>");
                                        out.println("</div>");
                                        out.println("<div class='job-listing-location mb-3 mb-sm-0 custom-width w-25' style='margin-top: 40px'>");
           ...
           <footer class="site-footer" style="background-color:black; margin-top : 0px;">

...
<html lang="en">
  <head>
    <title>&mdash;Register As Job_Seeker</title>
    <meta charset="utf-8">
	...
	<section class="section-hero overlay inner-page bg-image"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<h2 style="margin-top: 10%;" class="mb-6">Sign Up as Job Seeker</h2>
					<form action="RegisterUser" method="post" enctype="multipart/form-data" class="p-4 border rounded">
						...
						<div class="row form-group mb-4">
							<div class="col-md-12 mb-3 mb-md-0">
								...
								<input type="password" id="fname" style="margin-top: -1%;" name="retype" style="margin-top : -4%;" onblur = "validate()" class="form-control" placeholder="Re-type Password" required>
							</div>
						</div>
                 ...
                 <div>
                  <select name="SecurityQuestion" class="form-control" class="backup" style = "width : 490px; height : 35px;" required>                 
                     ...
                     <i class="fas fa-key fa-lg me-3 fa-fw"></i>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<input type="submit" value="Sign Up" class="btn px-6 btn-primary text-white" style = "margin-top : 30px;">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-md-12">
								<p class="text-center text-black mt-4 mb-0">Already have an account? <a href='login_JS.jsp' class="fw-bold text-body"><u>Login here</u></a>
								</p>
							</div>
						</div>
					</form>

...
<html lang="en">
  <head>
    <title>&mdash;Login As Employer</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <form action="LOGIN_EMP" method = "post" class="p-4 border rounded">
              ...
              <div class="row form-group">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style = "margin-top : -1%;" width="20" height="60" fill="currentColor" class="ionicon" viewBox="0 0 512 512">
                  ...
                  <label class="text-black" for="fname">Employer Email</label>
                  <input type="email" id="fname" name = "email" class="form-control" placeholder="Email email address" required>
                </div>
              </div>
              ...
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="password" id="fname" name = "cpass" class="form-control" placeholder="Password" required>
                </div>
              </div>
              
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" name = "fpass" value="Log In" class="btn px-6 btn-primary text-white">
                  <h5 class="text-center text-black mt-3 mb-1"><a href='forgotpassword_EMP.jsp'
                  class="fw-bold text-body"><u>Forgot Password?</u></a></h5>
                  <p class="text-center text-black mt-3 mb-1"><a href='REGISTER (EMP).jsp'
                  class="fw-bold text-body"><u>Create Account as Employer</u></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  <a href='REGISTER_Job Seeker.jsp' class="fw-bold text-body"><u>Create Account as Job Seeker</u></a></p>
                </div>
              </div>
            </form>
          </div>

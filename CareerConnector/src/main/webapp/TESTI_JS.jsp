...
<html lang="en">
  <head>
    <title>&mdash;Teastimonials</title>
    <meta charset="utf-8">
        ...
        <div class="row" style = "margin-top : 10px;">
          <div class="col-lg-6 mb-4">
            <div class="block__87154">
              <blockquote>
                  <p class = "txt_aln">&ldquo;I can't express enough how grateful I am for the incredible opportunity I found through Career Connector to kickstart my career as a QA tester. It's not just a job portal; it's a gateway to endless possibilities and a platform that truly values the aspirations of job seekers like me.
                    From the moment I created my profile on Career Connector, the experience was seamless and user-friendly. The interface was intuitive, making it effortless to browse through various job listings and filter them according to my preferences. I appreciated how easy it was to customize my job search to find positions that aligned with my skills and interests.&ldquo;</p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img class="image" src="images/testi1.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Rohan Sengupta</h3>
                  <span class="position">QA Tester</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 mb-4">
            <div class="block__87154">
              <blockquote>
                <p class = "txt_aln">&ldquo;I am thrilled to share my experience with Career Connector, the platform that played an instrumental role in shaping my career as a Data Analyst. Career Connector is not just a job-search website; it's a career accelerator, and I am a living testament to its effectiveness.
                  When I started my job hunt, I was looking for a platform that would streamline the process and connect me with the right opportunities. Career Connector exceeded my expectations in every aspect.&rdquo;</p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img class="image" src="images/testi2.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Prithwiraj Ray</h3>
                  <span class="position">Jr. Data Analyst</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 mb-4">
            <div class="block__87154">
              <blockquote>
                <p class = "txt_aln">&ldquo;I am excited to share my experience with Career Connector, a platform that not only simplifies job searching but also connects talent with the perfect opportunities. Career Connector was the catalyst for a transformative chapter in my career as an HR professional.
                  When I decided to explore new career prospects, I knew I needed a reliable partner in my job search. Career Connector turned out to be that and more. From the moment I created my profile, I was impressed by the user-friendly interface and the array of features designed to enhance the job-seeking experience.&rdquo;</p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img class="image" src="images/testi3.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Aditya Jaiswal</h3>
          ...
          <div class="col-lg-6 mb-4">
            <div class="block__87154">
              <blockquote>
                <p class = "txt_aln">&ldquo;I am excited to share my journey and express my gratitude to Career Connector, the platform that led me to my dream job as a Full Stack Web Developer. Career Connector is more than just a job search website; it's a dynamic gateway to professional growth and opportunity.
                  When I embarked on my job search as a Full Stack Web Developer, I sought a platform that would simplify the process and connect me with the right employers. Career Connector exceeded my expectations on all fronts.&rdquo;</p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img class="image" src="images/testi4.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Neeti Chowhan</h3>
                  <span class="position">Sr. Full Stack Web Developer</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12 mb-4">
            <div class="block__871541">
              <blockquote>
                <p class = "txt_aln" class="text-white" style="color: rgb(251, 250, 250);"> <i>&ldquo;I am excited to share my journey and express my gratitude to Career Connector, the platform that led me to my dream job as a Full Stack Web Developer. Career Connector is more than just a job search website; it's a dynamic gateway to professional growth and opportunity.
                  When I embarked on my job search as a Full Stack Web Developer, I sought a platform that would simplify the process and connect me with the right employers. Career Connector exceeded my expectations on all fronts.&rdquo;</i></p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img src="images/testi4.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3 class="text-white">Neeti Chowhan</h3>
                  <span class="position position-2" style="color: rgb(251, 250, 250);">Sr. Full Stack Web Developer</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 mb-4">
            <div class="block__87154">
              <blockquote>
                <p class = "txt_aln">&ldquo;What sets Career Connector apart is its cutting-edge job recommendation engine. This feature consistently provided tailored job suggestions based on my skills and preferences. It was like having a personal career advisor who understood my ambitions, making my job search highly efficient and effective.
                  The quality of job listings on Career Connector is exceptional. Each listing included detailed information about the role, the hiring company, and the qualifications required. This level of transparency enabled me to make well-informed decisions about which positions to pursue and invest my time in.&rdquo;</p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img class="image" src="images/testi5.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Mohini Chowdhury</h3>
          ...
          <div class="col-lg-6 mb-4">
            <div class="block__87154">
              <blockquote>
                <p class = "txt_aln">&ldquo;From the moment I registered, I was impressed by the user-friendly interface, which provided a seamless way to explore numerous job listings. Career Connector boasts a comprehensive set of search and filtering options that allowed me to identify roles that matched my expertise and career objectives, saving me valuable time and effort.
                  One of the standout features of Career Connector is its intelligent job recommendation engine. This feature consistently delivered personalized job suggestions tailored to my qualifications and preferences. It felt like having a dedicated career advisor who understood my career goals, making my job search highly efficient and effective.&rdquo;</p>
              </blockquote>
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img class="image" src="images/testi6.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Divya Paul</h3>

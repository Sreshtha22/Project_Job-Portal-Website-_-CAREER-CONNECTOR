...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%UserEmpBean userEmpBean=(UserEmpBean)session.getAttribute("Profile"); %>
<!doctype html>
<html>
<head>
<meta charset='utf-8'>
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="custom-breadcrumbs">
                        ...
                        <a href="login_EMP.jsp"><b style="color:white;">Log In</b></a> <span class="mx-2 slash">/</span>
...
<body oncontextmenu='return false' class='snippet-body'>
	<div class="container padding-bottom-3x mb-2 mt-5">
		<div class="row justify-content-center">
        	...
        	<%}%>
				<form class="card mt-4" action="forgotPasswordAction_EMP.jsp" method="POST">
					<div class="card-body">
						<div class="form-group">
							<label class="text-black" class="form-label" for="form3Example4cd">Registered email address</label>
							<input
								class="form-control" type="text" name="email" id="email-for-pass" placeholder="Email address" required="">
						</div>
                  ...
                  <select name="SecurityQuestion" class="form-control" class="backup" style = "width : 402px; height : 35px;">
                     ...
                     <option value="">What is your favourite food?</option>
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <input class="form-control" type="password" id="form3Example4cd" name="enpass" inputmode="numeric" minlength="6" maxlength="10" size="10" pattern="[A-Za-z0-9@#$%]{6,10}" title="Password must contains atleast one special character, one numeric value and one capital letter consisting of 6-10 digits" placeholder="Enter new password" class="form-control" required>
                           </div>
                           
						   <div style="margin-top: 20px;">
                        <button href = "login_EMP.jsp" class="btn btn-primary btn:hover" type="submit" style="background-color: rgb(36 106 175); height: 38px;">Submit</button>
					<!-- &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                        <button href = "login_EMP.jsp" class="btn btn-primary btn:hover"  style="background-color: rgb(36 106 175); height: 38px;">Log In</button> -->
					</div>
					</div>
				</form>
			</div>
